...
./shared/setup_shared_fdw.sh koordinator || exit 1
...
GHA2DB_PROJECT=koordinator PG_DB=koordinator ./shared/proj_affs_bootstrap.sh 2>>errors.txt | tee -a run.log || exit 9
