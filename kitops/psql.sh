...
GHA2DB_PROJECT=kitops PG_DB=kitops GHA2DB_LOCAL=1 gha2db 2024-03-07 0 today now 'regexp:(?i)^jozu-ai\/(.*kitops.*|gh-kit-setup|daggerverse)$' 2>>errors.txt | tee -a run.log || exit 3
