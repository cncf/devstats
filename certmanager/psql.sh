...
./shared/setup_shared_fdw.sh certmanager || exit 1
...
GHA2DB_PROJECT=certmanager PG_DB=certmanager ./shared/proj_affs_bootstrap.sh 2>>errors.txt | tee -a run.log || exit 5
