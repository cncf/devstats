...
./shared/setup_shared_fdw.sh screwdrivercd || exit 1
...
GHA2DB_PROJECT=screwdrivercd PG_DB=screwdrivercd ./shared/proj_affs_bootstrap.sh 2>>errors.txt | tee -a run.log || exit 6
