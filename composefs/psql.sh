...
GHA2DB_PROJECT=composefs PG_DB=composefs GHA2DB_LOCAL=1 gha2db 2021-10-30 0 today now 'containers/composefs,giuseppe/composefs' 2>>errors.txt | tee -a run.log || exit 3
