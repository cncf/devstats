...
update gha_repos
set repo_group = 'Flatcar', alias = 'Flatcar'
where lower(name) in (
  'flatcar/flatcar',
...
update gha_repos
set repo_group = 'scripts', alias = 'scripts'
where lower(name) in (
  'flatcar/scripts',
  'flatcar-linux/scripts',
  'kinvolk/flatcar-scripts'
);

update gha_repos
set repo_group = 'mantle', alias = 'mantle'
where lower(name) in (
  'flatcar/mantle',
