...
GHA2DB_PROJECT=ovnkubernetes PG_DB=ovnkubernetes GHA2DB_LOCAL=1 gha2db 2016-08-11 0 today now 'ovn-org,openvswitch/ovn-kubernetes' 2>>errors.txt | tee -a run.log || exit 3
