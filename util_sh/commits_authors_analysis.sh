...
GHA2DB_LOCAL=1 PG_DB=allprj GHA2DB_CSVOUT="report_alltime.csv" runq ./util_sql/commits_authors_analysis.sql {{exclude_bots}} "`cat util_sql/exclude_bots.sql`" {{skip_companies}} "'*unknown*', 'NotFound', '(Unknown)', ''" {{skip_repo_groups}} "'OPA', 'SPIFFE', 'SPIRE', 'CloudEvents', 'Telepresence', 'OpenMetrics', 'TiKV', 'Cortex', 'Buildpacks', 'Falco', 'Dragonfly', 'Virtual Kubelet'" {{user}} author qr '100 years,,' > report_alltime.txt
