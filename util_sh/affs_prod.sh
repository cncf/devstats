...
ONLY="kagent urunc xregistry modelpack kserve oauth2proxy oxia holmesgpt cedarpolicy dalec openchoreo cohdi kubeelasti kaischeduler agones" ./devel/all_affs.sh || exit 19
GHA2DB_RECENT_RANGE="4 hours" GHA2DB_TMOFFSET="-4" devstats
