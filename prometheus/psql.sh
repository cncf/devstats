...
GHA2DB_PROJECT=prometheus PG_DB=prometheus GHA2DB_LOCAL=1 gha2db 2015-01-01 0 today now 'prometheus,OpenObservability,OpenMetrics,openmetrics,RichiH/OpenMetrics' 2>>errors.txt | tee -a run.log || exit 2
