...
PROJ=kubernetes PROJDB=gha PROJREPO="kubernetes/kubernetes" ORGNAME=Kubernetes PORT=2999 ICON=kubernetes GRAFSUFF=k8s GA="" SKIPGRAFANA=1 GHA2DB_LOCAL=1 GHA2DB_GITHUB_OAUTH="-" GHA2DB_GHAPISKIP=1 GHA2DB_AECLEANSKIP=1 ./devel/deploy_proj.sh || exit 3
echo 'All OK'
