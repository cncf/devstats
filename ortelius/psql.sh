...
./devel/db.sh psql ortelius -c "create extension if not exists hll" || exit 1
./shared/setup_shared_fdw.sh ortelius || exit 1
GHA2DB_PROJECT=ortelius PG_DB=ortelius GHA2DB_LOCAL=1 gha2db 2017-03-06 0 today now "ortelius/azure-infra,ortelius/backstage,ortelius/cli,ortelius/dev-env-setup,ortelius/keptn-config,ortelius/keptn-ortelius-service,ortelius/la-sbom-ledger,ortelius/ms-compitem-crud,ortelius/ms-dep-pkg-cud,ortelius/ms-dep-pkg-r,ortelius/ms-postgres,ortelius/ms-scorecard,ortelius/ms-textfile-crud,ortelius/ms-validate-user,ortelius/ortelius,ortelius/ortelius-charts,ortelius/ortelius-docs,ortelius/ortelius-kubernetes,ortelius/ortelius-python-client,ortelius/ortelius-test-database,ortelius/ortelius-toc,ortelius/ortelius.io,ortelius/outreach" 2>>errors.txt | tee -a run.log || exit 2
...
GHA2DB_PROJECT=ortelius PG_DB=ortelius ./shared/proj_affs_bootstrap.sh 2>>errors.txt | tee -a run.log || exit 6
