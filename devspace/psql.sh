...
GHA2DB_PROJECT=devspace PG_DB=devspace GHA2DB_LOCAL=1 gha2db 2017-10-13 0 today now 'devspace-sh,devspace-cloud,covexo' 2>>errors.txt | tee -a run.log || exit 2
