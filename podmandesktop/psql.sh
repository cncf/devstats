...
./shared/setup_shared_fdw.sh podmandesktop || exit 1
...
GHA2DB_PROJECT=podmandesktop PG_DB=podmandesktop ./shared/proj_affs_bootstrap.sh 2>>errors.txt | tee -a run.log || exit 9
