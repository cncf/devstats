...
./shared/setup_shared_fdw.sh bankvaults || exit 1
...
GHA2DB_PROJECT=bankvaults PG_DB=bankvaults ./shared/proj_affs_bootstrap.sh 2>>errors.txt | tee -a run.log || exit 9
