...
./shared/setup_shared_fdw.sh loggingoperator || exit 1
...
GHA2DB_PROJECT=loggingoperator PG_DB=loggingoperator ./shared/proj_affs_bootstrap.sh 2>>errors.txt | tee -a run.log || exit 9
