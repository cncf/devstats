...
select
  ...
  as name,
  greatest(avg(open_to_lgtm), 0) as m_o2l_a,
  greatest(avg(lgtm_to_approve), 0) as m_l2a_a,
  greatest(avg(approve_to_merge), 0) as m_a2m_a,
  ...
  greatest(avg(open_to_lgtm) filter (where api_change = 'yes'), 0) as m_o2l_y,
  greatest(avg(lgtm_to_approve) filter (where api_change = 'yes'), 0) as m_l2a_y,
  greatest(avg(approve_to_merge) filter (where api_change = 'yes'), 0) as m_a2m_y,
  ...
  greatest(avg(open_to_lgtm) filter (where api_change = 'no'), 0) as m_o2l_n,
  greatest(avg(lgtm_to_approve) filter (where api_change = 'no'), 0) as m_l2a_n,
  greatest(avg(approve_to_merge) filter (where api_change = 'no'), 0) as m_a2m_n,
