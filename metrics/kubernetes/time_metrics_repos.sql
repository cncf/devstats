...
select
  ...
  greatest(avg(open_to_lgtm) filter (where $3), 0) as m_o2l_y,
  greatest(avg(lgtm_to_approve) filter (where $3), 0) as m_l2a_y,
  greatest(avg(approve_to_merge) filter (where $3), 0) as m_a2m_y,
  ...
  greatest(avg(open_to_lgtm) filter (where $3), 0) as m_o2l_n,
  greatest(avg(lgtm_to_approve) filter (where $3), 0) as m_l2a_n,
  greatest(avg(approve_to_merge) filter (where $3), 0) as m_a2m_n,
