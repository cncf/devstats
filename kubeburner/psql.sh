...
./shared/setup_shared_fdw.sh kubeburner || exit 1
...
GHA2DB_PROJECT=kubeburner PG_DB=kubeburner ./shared/proj_affs_bootstrap.sh 2>>errors.txt | tee -a run.log || exit 9
