...
./shared/setup_shared_fdw.sh openfunction || exit 1
...
GHA2DB_PROJECT=openfunction PG_DB=openfunction ./shared/proj_affs_bootstrap.sh 2>>errors.txt | tee -a run.log || exit 5
