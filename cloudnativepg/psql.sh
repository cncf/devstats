...
./shared/setup_shared_fdw.sh cloudnativepg || exit 1
...
GHA2DB_PROJECT=cloudnativepg PG_DB=cloudnativepg ./shared/proj_affs_bootstrap.sh 2>>errors.txt | tee -a run.log || exit 9
