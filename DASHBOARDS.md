...
- Bus factor in Repository Groups: [bus-factor.json](https://github.com/cncf/devstats/blob/master/grafana/dashboards/all/bus-factor-in-repository-groups.json), [view](https://all.devstats.cncf.io/d/84/bus-factor-in-repository-groups)
