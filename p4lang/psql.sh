...
./devel/db.sh psql p4lang -c "create extension if not exists hll" || exit 1
./shared/setup_shared_fdw.sh p4lang || exit 1
...
GHA2DB_PROJECT=p4lang PG_DB=p4lang ./shared/proj_affs_bootstrap.sh 2>>errors.txt | tee -a run.log || exit 9
