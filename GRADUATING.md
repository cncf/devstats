...
- Update files: `partials/projects.html partials/projects_health.html metrics/all/sync_vars.yaml` (remember about `cncf-` classes/separators). Look for `DevStats projects:\|Projects:\|Graduated:\|Incubating:\|Sandbox:` - update counts.
