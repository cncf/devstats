...
- Update files: `vim partials/projects.html partials/projects_health.html metrics/all/sync_vars.yaml apache/www/index_prod.html apache/www/index_test.html` (remember about `cncf-` classes/separators). Look for `/\cdevstats projects:\|projects:\|graduated:\|incubating:\|sandbox:\|archived:` - update counts.
