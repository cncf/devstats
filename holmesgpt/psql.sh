...
GHA2DB_PROJECT=holmesgpt PG_DB=holmesgpt GHA2DB_LOCAL=1 gha2db 2024-05-30 0 today now 'robusta-dev/holmesgpt,robusta-dev/homebrew-holmesgpt,robusta-dev/holmesgpt-community-toolsets' 2>>errors.txt | tee -a run.log || exit 3
